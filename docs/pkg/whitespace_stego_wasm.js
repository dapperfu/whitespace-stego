/* @ts-self-types="./whitespace_stego_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function decode_message(encoded_text, password) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(encoded_text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function encode_message(message, carrier, password) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(message, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        var ptr1 = isLikeNone(carrier) ? 0 : passStringToWasm0(carrier, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        var ptr2 = isLikeNone(password) ? 0 : passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        const ret = wasm.encode_message(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @returns {boolean}
 */
export function has_encoded_data(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.has_encoded_data(ptr0, len0);
    return ret !== 0;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./whitespace_stego_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('whitespace_stego_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
