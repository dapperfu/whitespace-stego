...
/// Zero-width space character used as start marker
pub const START_MARKER: char = '\u{200B}';

/// Zero-width non-joiner character used as end marker
pub const END_MARKER: char = '\u{200C}';

/// Zero-width joiner character used to represent zero bits
pub const ZERO_BIT: char = '\u{200D}';

/// Zero-width no-break space character used to represent one bits
pub const ONE_BIT: char = '\u{FEFF}';
