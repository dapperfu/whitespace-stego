...
class TestCImplementationCoverage:
    ...
    def test_c_cli_error_handling(self):
        ...
        try:
            ...
            # Test empty message file (should fail with humorous error)
            ...
            assert result.returncode != 0
            assert "🤔 There's no point in encoding nothing!" in result.stderr
