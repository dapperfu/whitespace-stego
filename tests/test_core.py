...
from whitespace_stego.core import decode, encode, extract_encoded, START_MARKER, END_MARKER
...
def test_encode_decode(message: str, password: str | None, carrier: str) -> None:
