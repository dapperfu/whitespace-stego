    ...
    def test_c_cli_basic_encode_decode(self):
        ...
        try:
            ...
            try:
                ...
                for file_path in [message_file, carrier_file, output_file, decode_output]:
    ...
    def test_c_cli_password_protection(self):
        ...
        try:
            ...
            try:
                ...
                for file_path in [message_file, carrier_file, output_file, decode_output, wrong_decode_output]:
                    if Path(file_path).exists():
                        os.unlink(file_path)
    ...
    def test_c_python_cross_compatibility(self):
        ...
        try:
            ...
            try:
                ...
                for file_path in [message_file, carrier_file, c_output_file, py_output_file, decode_output]:
                    if Path(file_path).exists():
                        os.unlink(file_path)
    ...
    def test_c_rust_cross_compatibility(self):
        ...
        try:
            ...
            try:
                ...
                for file_path in [message_file, carrier_file, c_output_file, rust_output_file, decode_output]:
                    if Path(file_path).exists():
                        os.unlink(file_path)
