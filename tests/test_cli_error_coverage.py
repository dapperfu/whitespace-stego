...
class TestCLIErrorHandling:
            ...
            with patch("whitespace_stego.cli.logger") as mock_logger:
                with patch(
                    ...
                    side_effect=ImportError(
                        "No module named 'whitespace_stego_backend'"
                    ),
                ):
        ...
        with patch("whitespace_stego.cli.sys") as mock_sys:
            with patch("whitespace_stego.cli.logger") as mock_logger:
                with patch(
                    "builtins.__import__",
                    side_effect=ImportError(
                        "No module named 'whitespace_stego.c_backend'"
                    ),
                ):
    ...
    def test_cli_verbose_logging(self):
        ...
        runner = CliRunner()
        with patch("whitespace_stego.cli.setup_logger") as mock_setup_logger:
    ...
    def test_encode_file_read_error(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                "pathlib.Path.read_text", side_effect=OSError("File read error")
            ):
    ...
    def test_encode_encoding_error(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                "whitespace_stego.cli.encode_message",
