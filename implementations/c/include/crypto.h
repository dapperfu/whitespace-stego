 ...
 * @param data_len Length of data
 * @param password Password to use for encryption
 * @param result_buffer Static buffer to store encrypted data
...
/**
 * @brief Decrypt data using a password with static buffer
 *
 * @param data Encrypted data
 * @param data_len Length of encrypted data
 * @param password Password to use for decryption
 * @param result_buffer Static buffer to store decrypted data
 * @param result_buffer_size Size of the result buffer
 * @param result_len Pointer to store length of decrypted data
 * @return 1 if decryption was successful, 0 otherwise
 */
