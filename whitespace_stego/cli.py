...
@cli.command()
@click.option('--message-file', '-m', required=True, type=click.Path(exists=True, path_type=Path),
              help='Path to the file containing the message to encode')
@click.option('--carrier-file', '-c', required=True, type=click.Path(exists=True, path_type=Path),
